...
namespace ML__Net_Core_Research__Taxi_Fares_ML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Justin\source\repos\ML-.Net-Core-Research-Taxi-Fares-\ML .Net Core Research (Taxi Fares)\taxi-fare-train.csv";
        private static string MODEL_FILEPATH = @"../../../../ML__Net_Core_Research__Taxi_Fares_ML.Model/MLModel.zip";
